...
public final class Utils {
    ...
    public static void addClosedLoopProperties(String name, TalonFX motor, SendableBuilder builder) {
        builder.addDoubleProperty(name + " voltage (V)", () -> motor.getMotorVoltage().getValueAsDouble(), (__) -> {
        });
        ...
        builder.addDoubleProperty(name + " raw velocity", () -> motor.getVelocity().getValueAsDouble(), (__) -> {
        });
