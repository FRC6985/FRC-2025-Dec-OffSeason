...
public final class Utils {
  ...
  public static Translation2d mirrorIfRed(Translation2d t) {
    return Robot.getInstance().isRedAlliance() ? mirror(t) : t;
  }

  public static Rotation2d mirrorIfRed(Rotation2d r) {
    return Robot.getInstance().isRedAlliance() ? mirror(r) : r;
  }

  public static Pose2d mirrorIfRed(Pose2d p) {
    return Robot.getInstance().isRedAlliance() ? mirror(p) : p;
  }
  ...
  public static boolean atGoodScoringDistance() {
    ...
    Pose2d estimatedPose = Robot.getInstance().drive.poseEstimator.getEstimatedPosition();
