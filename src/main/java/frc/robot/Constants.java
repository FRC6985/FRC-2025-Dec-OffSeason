...
public final class Constants {
  ...
  public static final class CanIds {
    public static int INTAKE_ROLLER_MOTOR = 30;
    public static int INTAKE_CENTERING_MOTOR = 31;
    public static int INTAKE_PIVOT_MOTOR = 32;
    public static int ARM_PIVOT_MOTOR = 35;
    public static int ARM_ROLLER_MOTOR = 37;
    public static int ELEVATOR_MAIN_MOTOR = 40;
    public static int ELEVATOR_FOLLOWER_MOTOR = 41;
  }

  public static final class DioIds {

    public static int INTAKE_LINEBREAK = 2;
